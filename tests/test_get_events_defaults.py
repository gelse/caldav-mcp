...
class GetEventsDefaultsTest(unittest.TestCase):
    def test_default_start_is_server_local_midnight(self):
        ...
        self.assertEqual(start_dt.isoformat(), "2026-08-18T00:00:00+02:00")
        self.assertEqual(start_dt.hour, 0)
        self.assertEqual(start_dt.minute, 0)
        self.assertEqual(start_dt.second, 0)
        self.assertEqual(start_dt.microsecond, 0)
        self.assertEqual(start_dt.utcoffset(), timedelta(hours=2))
    ...
    def test_default_start_uses_utc_midnight_when_server_is_utc(self):
        ...
        self.assertEqual(start_dt.isoformat(), "2026-08-18T00:00:00+00:00")
        self.assertEqual(end_dt, start_dt + timedelta(days=1))
