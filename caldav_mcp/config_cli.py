...
from caldav_mcp.key_hash import hash_api_key, verify_api_key  # noqa: F401 (re-export)

# Re-exported from caldav_mcp.key_hash for backward compatibility (M3.3 tests).
# Do not remove — this module is part of the public API surface.
